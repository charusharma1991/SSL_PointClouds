...
class DGCNN(nn.Module):
    def __init__(self, args, output_channels=40):
        ...
        self.bn5 = nn.BatchNorm1d(args.emb_dims)
        self.conv0 = nn.Sequential(nn.Conv1d(128, 16, kernel_size=1, bias=False),
                                   self.bn0,
        ...
        self.linear3 = nn.Linear(256, args.train_K_way)
...
class PointNetfeat(nn.Module):
    def __init__(self, args,global_feat=True):
...
class PointNetCls(nn.Module):
    def __init__(self, args, output_channels=10):
        ...
        self.feat = PointNetfeat(args,global_feat=True)
        self.fc1 = nn.Linear(1024, 512)
        self.fc2 = nn.Linear(512, 256)
        self.fc3 = nn.Linear(256, args.train_K_way)
